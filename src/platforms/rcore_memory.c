...
int InitPlatform(void)
{
    ...
    {
        TRACELOG(LOG_LEVEL_WARNING, "DISPLAY: Memory platform requires software renderer (GRAPHICS_API_OPENGL_SOFTWARE)");
    ...
    TRACELOG(LOG_LEVEL_INFO, "PLATFORM: MEMORY: Initialized successfully");
